...
import { an_tajalaContent } from '~/utils/an_taj`ala'
...
const content = an_tajalaContent
...
<template>
    <h1 class="text-green-700 font-bold py-6 font-serif text-4xl text-center">Dua An Taj`ala</h1>
