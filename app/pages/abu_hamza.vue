...
import { abu_hamzaContent } from '~/utils/abu_hamza'
...
const content = abu_hamzaContent
...
<template>
    <h1 class="text-green-700 font-bold py-6 font-serif text-4xl text-center">Dua Abu Hamza al Thumali</h1>
