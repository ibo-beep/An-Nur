...
<template>
    <h1 class="text-green-700 font-bold py-6 font-serif text-4xl text-center">Dua Tawassul</h1>
  <div class="max-w-4xl mx-auto p-6 bg-white rounded-2xl shadow-lg border border-gray-100">
    <div class="flex bg-gray-100 p-1 rounded-xl mb-6">
      <button 
        ...
        class="flex-1 py-3 text-sm font-semibold rounded-lg transition-all duration-200"
    ...
    <div class="p-10 border border-gray-100 bg-[#fcfdfc] rounded-3xl min-h-[300px] flex items-center justify-center">
      <p class="whitespace-pre-line text-center leading-[3rem] text-gray-800 text-3xl font-arabic">
