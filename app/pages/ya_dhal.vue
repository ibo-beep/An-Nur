...
import { ya_dhalContent } from '~/utils/ya_dhal'
...
<template>
    <h1 class="text-green-700 font-bold py-6 font-serif text-4xl text-center">Dua Ya Dhal</h1>
