...
import { jawshanContent } from '~/utils/jawshan'
...
<template>
    <h1 class="text-green-700 font-bold py-6 font-serif text-4xl text-center">Dua Jawshan al Kabir</h1>
